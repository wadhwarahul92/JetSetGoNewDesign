jetsetgo_app.controller 'JetSetYatraEnquiryController', ['$http', 'notify', 'AirportsService', '$scope', '$location', '$routeParams', 'CurrentUserService', ($http, notify, AirportsService, $scope, $location, $routeParams, CurrentUserService)->
