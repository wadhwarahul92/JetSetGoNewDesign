jetsetgo_app.controller 'JetSetRescueEnquiryController', ['$http', 'notify', '$scope', ($http, notify, $scope)->

  @package = ['Bed to Bed Services', 'Emergency Medical Retrieval Service', 'Quick Reliable Transfers']
  @enquiry = {}
