jetsetgo_app.controller 'JetSetWedEnquiryController', ['$http', 'notify', '$scope', ($http, notify, $scope)->

  @package = ['Engagement', 'Wedding', 'Conference', 'Group Gateways', 'Celebrity', 'Sports']
  @enquiry = {}
