...
#    total_flight_mins =  (((hours*60) + minutes))
    ...
    if trip.flight_plan
      if trip.miscellaneous_cost > 0
        trip.is_miscellaneous_expenses = true
        cost += trip.miscellaneous_expenses_amount = trip.miscellaneous_cost + (trip.miscellaneous_cost*trip.aircraft.flight_cost_commission_in_percentage/100)
