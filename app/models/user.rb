class User < ActiveRecord::Base
  ...
  has_attached_file :image, presence: false, styles: {small: '50x50!', size_250x250: '250x250!'}, default_url: 'http://d3tfanr7troppj.cloudfront.net/static_files/images/000/000/254/original/image_user.png'
